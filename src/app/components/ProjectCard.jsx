    ...
    return (
        ...
        <div className="h-52 md:h-72 rounded-t-xl relative group" style={{background: `url(${imgUrl})`, backgroundSize: "cover" }}>
            ...
            <Link className='h-14 w-14 border-2 relative rounded-full border-[#ADB7BE] hover:border-white group/link mr-2' href={gitUrl}>
                    <CodeBracketIcon className="h-10 w-10 text-[#ADB7BE] cursor-pointer hover:white absolute top-1/2 left-1/2 tranform -translate-x-1/2 -translate-y-1/2 group-hover/link:text-white " />
                    </Link>

                    <Link className='h-14 w-14 border-2 relative rounded-full border-[#ADB7BE] hover:border-white group/link' href={previewUrl}>
                    <EyeIcon className="h-10 w-10 text-[#ADB7BE] cursor-pointer hover:white absolute top-1/2 left-1/2 tranform -translate-x-1/2 -translate-y-1/2 group-hover/link:text-white" />
                    </Link>
            </div>
            </div>
